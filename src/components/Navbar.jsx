          ...
          <ul className="flex gap-6 items-center">
            <li>
              ...
              <div
                ...
                className={
                  !dropdown
                    ? "hidden absolute z-10 font-normal bg-white divide-y divide-gray-100 px-2 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600"
                    : "z-10 absolute font-normal bg-white divide-y divide-gray-100 px-2 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600"
                }
              >
                <ul
